...
- 大核模式（CPU `4-7`，ORT `intraOp=2`）n/s/m/l/x 平均总耗时为 `461.5/1306.0/4042.0/5277.5/11757.5 ms`，FPS 为 `2.167/0.766/0.247/0.189/0.085`。
- 小核模式（CPU `0-3`，ORT `intraOp=2`）n/s/m/l/x 平均总耗时为 `1066.5/2992.0/8508.0/11086.5/23917.0 ms`，FPS 为 `0.938/0.334/0.118/0.090/0.042`。
- 五模型一轮正式样本合计约为大核 `22.845 s`、小核 `47.570 s`；多核模式实际使用 2 个 ORT 推理线程，不能据此宣称使用 4 个核心满载。
