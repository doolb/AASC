...
import com.aasc.display.vision.ocr.CtcDecoder
...
class CtcDecoderTest {
    ...
    fun repeatedTokensAndBlankAreCollapsed() {
        val logits = arrayOf(floatArrayOf(8f, 0f, 0f), floatArrayOf(0f, 8f, 0f), floatArrayOf(0f, 7f, 0f), floatArrayOf(8f, 0f, 0f), floatArrayOf(0f, 0f, 8f))
