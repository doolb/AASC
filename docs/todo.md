...
- ⏳待现场验证 [2026-09-25] MindAR Basic 外网示例手机识别
  ...
  - 关联文档：`docs/design/mindar-basic-web.md`、`docs/spec/mindar-basic-web.md`、`docs/task/2026-09-25_MindAR官方Basic示例外网发布.md`、`docs/task/2026-09-25_MindAR-Basic自定义图片定位.md`、`docs/task/2026-09-25_MindAR-Basic固定矩形裁剪.md`、`docs/task/2026-09-25_MindAR-Basic裁剪编辑与面板收起.md`。
...
- ⏳待现场验证 [2026-09-23] MMD AR MindAR 真机跟踪与正式显示端迁移评估
