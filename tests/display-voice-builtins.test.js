...
assert.match(helpHandler, /sendVoiceInputTtsSentences\(helpTTS, targetDisplayId\)/);
...
const ttsWaitIndex = helpHandler.indexOf('await sendVoiceInputTtsSentences(helpTTS, targetDisplayId)');
