...
assert.match(statusBody, /activeGroup/);
assert.match(statusBody, /activePrivate/);
assert.match(statusBody, /voiceConversationTarget/);
assert.match(statusBody, /群聊/);
assert.match(statusBody, /私聊/);
